...
## Objective 
To analyse customer data, identify key business insights, and provide practical recommendations that support business decision-making.

## 📘Project Overview 
- This project analyses telecom customer data to identify key factors contributing to customer churn.
- The dataset includes information on 7,042 customers, covering demographics, services, contracts, and billing details.

## 🎯Business Objective
To analyse and identify the factors leading to customer churn and to provide actionable insights that help improve retention, customer satisfaction, and overall business performance.
...
- Provide customised plans for senior citizens and low-tenure customers.
- Use predictive analytics to identify at-risk customers early.

## 🧭Tools and Technologies Used
- Databricks ipynb notebooks - for python coding, visualisation, and preprocessing my data
- PowerPoint - Presentation
- Loveableai to create dashboard insights -
